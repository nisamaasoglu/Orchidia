...
> **Training is optional.** Orchidia runs immediately in demo mode
> (`pip install -r requirements.txt && python app.py`). Follow the steps below only
> when you want real species recognition instead of the illustrative demo.
